...
constexpr inline std::uint32_t timer_tick_hz = 16'000'000U;
...
constexpr inline std::uint32_t tim2_psc = (hal::clock::apb1_timer_hz / timer_tick_hz) - 1U;

inline void initialize_timer() {

   auto init_tim2 = stm32::tim2("cr1.UIFREMAP"_f = false,                           //
                                "cr1.CKD"_f = 0x00,                                 //
                                "cr1.ARPE"_f = true,                                //
                                "cr1.CMS"_f = 0x00,                                 //
                                "cr1.DIR"_f = false,                                //
...
inline void enable_timer() { groov::sync_write(stm32::tim2("cr1.CEN"_f = true)); }

inline void disable_timer() { groov::sync_write(stm32::tim2("cr1.CEN"_f = false)); }

inline void reset_timer() { groov::sync_write(stm32::tim2("cnt.CNT"_f = 0x00)); }
