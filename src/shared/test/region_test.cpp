...
template <typename F>
error_receiver(F) -> error_receiver<F>;
...
template <typename F>
stop_receiver(F) -> stop_receiver<F>;
...
constexpr auto unique_name =
    stdx::ct_string<stdx::type_as_string<T>().size() + 1>{stdx::type_as_string<T>()};
...
TEMPLATE_TEST_CASE("acquire adaptor completes immediately when not busy", "[region]",
                   decltype([] {})) {
...
TEMPLATE_TEST_CASE("acquire adaptor enqueues when busy", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
...
TEMPLATE_TEST_CASE("acquire adaptor forwards upstream values", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("acquire adaptor forwards upstream values when queued", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
   ...
   CHECK((async::just() | region::detail::release<name>() | async::sync_wait()).has_value());
   CHECK(got == 99);
}

TEMPLATE_TEST_CASE("acquire adaptor acquires and forwards upstream error", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;

   int err = 0;
   auto op = async::connect(async::just_error(5) | region::detail::acquire<name>(),
...
TEMPLATE_TEST_CASE("acquire adaptor acquires and forwards upstream stop", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;

   bool stopped = false;
   auto op = async::connect(async::just_stopped() | region::detail::acquire<name>(),
...
TEMPLATE_TEST_CASE("acquire adaptor enqueues on error channel when busy", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;

   bool woke = false;
   auto op = async::connect(async::just_error(3) | region::detail::acquire<name>(),
...
TEMPLATE_TEST_CASE("release adaptor hands off to queued waiter", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
...
TEMPLATE_TEST_CASE("release adaptor forwards upstream values", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
...
TEMPLATE_TEST_CASE("release adaptor forwards upstream values with waiter", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
...
TEMPLATE_TEST_CASE("release adaptor fires on error channel and forwards error", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;

   int err = 0;
   auto op = async::connect(async::just_error(123) | region::detail::release<name>(),
                            error_receiver{[&](int e) { err = e; }});
   async::start(op);
   CHECK(err == 123);
   CHECK(region::detail::waiters_<name> == 0);
...
TEMPLATE_TEST_CASE("release adaptor fires on error channel and wakes waiter", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
   ...
   auto op = async::connect(async::just_error(0) | region::detail::release<name>(),
                            universal_receiver{});
   async::start(op);
   CHECK(waiter_woke);
...
TEMPLATE_TEST_CASE("release adaptor fires on stop channel and forwards stop", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;

   bool stopped = false;
   auto op = async::connect(async::just_stopped() | region::detail::release<name>(),
                            stop_receiver{[&] { stopped = true; }});
   async::start(op);
   CHECK(stopped);
   CHECK(region::detail::waiters_<name> == 0);
...
TEMPLATE_TEST_CASE("release adaptor fires on stop channel and wakes waiter", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
...
TEMPLATE_TEST_CASE("release wakes waiters in FIFO order", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 1;
...
TEMPLATE_TEST_CASE("within runs sender between acquire and release", "[region]",
   ...
   int value = 0;
   auto s = async::just_result_of([&] { value = 42; });
   CHECK((async::just() | region::within<name>(s) | async::sync_wait()).has_value());
   CHECK(value == 42);
   CHECK(region::detail::waiters_<name> == 0);
}
...
TEMPLATE_TEST_CASE("within serializes sequential operations", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
   ...
   CHECK((async::just() | region::within<name>(s1) | async::sync_wait()).has_value());

   auto s2 = async::just_result_of([&] { trace.push_back(2); });
   CHECK((async::just() | region::within<name>(s2) | async::sync_wait()).has_value());
...
TEMPLATE_TEST_CASE("within queues when busy", "[region]", decltype([] {})) {
   ...
   auto op2 = async::connect(async::just() | region::within<name>(s2), universal_receiver{});
   async::start(op2);
...
TEMPLATE_TEST_CASE("within threads the upstream value into an adaptor arg", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
   ...
   int got = 0;
   CHECK((async::just(41) | region::within<name>(s) | async::then([&](int v) { got = v; }) |
          async::sync_wait())
             .has_value());
   CHECK(got == 42);
   CHECK(region::detail::waiters_<name> == 0);
...
TEMPLATE_TEST_CASE("within threads an upstream error into an adaptor arg", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("second acquire blocks while first holds bus", "[region]",
   ...
   auto op1 = async::connect(async::just_result_of([&] { trace.push_back(1); }) |
...
TEMPLATE_TEST_CASE("within cancels while queued and never acquires", "[region]",
   ...
   // Hold the region so within must queue.
   auto hold_op =
       async::connect(async::just() | region::detail::acquire<name>(), universal_receiver{});
   async::start(hold_op);
   ...
   auto op = async::connect(async::just() | region::within<name>(s),
...
TEMPLATE_TEST_CASE("cancelling a queued within leaves other waiters intact", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
   ...
   auto y_op =
       async::connect(async::just() | region::within<name>(y_s),
...
TEMPLATE_TEST_CASE("within completes stopped if stop is already requested", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("a hand-off beats a later cancel", "[region]", decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("within cancels mid-region and still releases", "[region]",
   ...
   auto next_op = async::connect(
       async::just() | region::within<name>(async::just_result_of([&] { next_ran = true; })),
       universal_receiver{});
   async::start(next_op);
   CHECK(next_ran);
   CHECK(region::detail::waiters_<name> == 0);
...
TEMPLATE_TEST_CASE("cancelling mid-region hands off to the next waiter", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("within cancels mid-region after being handed the region", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
...
TEMPLATE_TEST_CASE("a mid-region body that completes beats a later cancel", "[region]",
                   decltype([] {})) {
   constexpr auto name = unique_name<TestType>;
   region::detail::waiters_<name> = 0;
   ...
   auto const work = [&] {
      for (auto i = 0; i < iterations; ++i) {
         ...
         auto op = async::connect(
             ...
             counting_receiver{std::addressof(value_count), std::addressof(done)});
         async::start(op);
