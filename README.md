...
This project show cases meta-modern (contemporary) techniques for constructing bare-metal embedded firmware solutions. It focuses on solving Structural Quality concerns.

The targeted dev board is a [STM32 NUCLEO-L432KC](https://www.st.com/en/evaluation-tools/nucleo-l432kc.html) which has an [STM32L432KC](https://www.st.com/en/microcontrollers-microprocessors/stm32l432kc.html) device.
...
> [!Note]
> This project is WIP. Much will change as I refine how to articulate in words and code
...
I'm using the official [Arm GNU Toolchain](https://developer.arm.com/Tools%20and%20Software/GNU%20Toolchain) release 14.3 via WSL Ubuntu. The instructions below will be from the point of view of using WSL for development. This is almost identical to using a native Linux boot.
...
These are the things I did to make `openocd` work on a Mac some years ago.
...
This will result in the elf file `build/demo` which can be loaded onto the target using gdb as explained above.
